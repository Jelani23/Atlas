...
const tests = [
    'projectQuestion.test.js',
    'sourceBundle.test.js',
    'primitiveSemantics.test.js',
    'semanticConsistency.test.js',
    'branchConclusions.test.js',
    'spokenAnalysis.test.js',
    'answerCoverage.test.js',
    'operationEvidence.test.js',
    'functionBehavior.test.js',
    'functionInputs.test.js',
    'booleanReturnOutline.test.js',
    'functionCompletion.test.js',
    'functionScenario.test.js',
    'symbolScope.test.js',
    'questionInputs.test.js',
    'staticRelations.test.js',
    'profileEvidence.test.js',
    'focusedAnalysis.test.js',
    'sourceStructure.test.js',
    'projectUnderstanding.test.js',
    'projectUnderstandingDatabase.test.js',
