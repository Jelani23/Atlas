...
const TOOL_ARGUMENTS = {
    ...
    readCode: [{ name: 'filePaths', type: 'stringOrStringArray' },
        { name: 'startLine', type: 'positiveInteger', optional: true },
        { name: 'lineCount', type: 'positiveInteger', optional: true, description: '1–200 lines; defaults to 80. Output is also character-bounded.' },
        { name: 'expectedVersion', type: 'string', optional: true, description: 'SHA-256 from the previous read; rejects changed source.' }],
